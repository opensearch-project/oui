...
- Consolidate security dependency bumps for prismjs, lodash, puppeteer, fork-ts-checker-webpack-plugin, and related transitive packages ([#1772](https://github.com/opensearch-project/oui/pull/1772))
