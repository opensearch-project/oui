...
const invalid = [
    ...
    errors: [
      {
        ...
        data: {
          tokenValue: 'ouiFooeyBar.tokenName',
          tokenNamespace: 'ouiFooBar',
        },
      },
    ],
  },
  ...
  // token doesn't have at least two parts
  {
    ...
    errors: [
      {
        messageId: 'invalidToken',
        data: { tokenValue: 'ouiFooBar', tokenNamespace: 'ouiFooBar' },
      },
    ],
  },
  {
    ...
    errors: [
      {
        messageId: 'invalidToken',
        data: { tokenValue: 'tokenName', tokenNamespace: 'ouiFooBar' },
      },
    ],
  },
  ...
  // invalid tokens
  {
    ...
    errors: [
      {
        messageId: 'invalidToken',
        data: { tokenValue: 'token2', tokenNamespace: 'ouiFooBar' },
      },
    ],
  },
  {
    ...
    errors: [
      {
        messageId: 'invalidToken',
        data: { tokenValue: 'ouiFooeyBar.token1', tokenNamespace: 'ouiFooBar' },
      },
    ],
  },
  {
