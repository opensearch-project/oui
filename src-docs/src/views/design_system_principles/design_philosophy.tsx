  ...
  return (
    <GuidePage title="Design Philosophy">
      ...
      <OuiFlexGroup gutterSize="l">
        ...
        <OuiFlexItem>
          <OuiPanel>
            ...
            <OuiText size="s">
              <p>
                OUI balances established patterns with thoughtful innovation.
                We favor proven conventions but are not afraid to introduce new
      ...
      <OuiText grow={false}>
        ...
        <p>
          OpenSearch serves four core focus areas, each with distinct user
          needs and workflow characteristics. OUI&apos;s design philosophy is
          shaped by these domains, ensuring that components and patterns work
          well in the contexts where they are most needed.
        </p>
      </OuiText>
      ...
      <OuiText grow={false}>
        <p>
          ...
          data while keeping the interaction fast and focused. The design
          favors progressive disclosure — showing essential controls upfront
          and revealing advanced options on demand.
        </p>
      </OuiText>
      ...
      <OuiText grow={false}>
        <p>
          ...
          able to assess system health or key metrics at a glance, then
          interact with individual panels for deeper exploration.
        </p>
      </OuiText>
      ...
      <OuiText grow={false}>
        ...
        <p>
          ...
          understood iconography reduce the learning curve for new users. At
          the same time, OpenSearch&apos;s unique requirements — such as
          complex query building, multi-dimensional data exploration, and
          real-time monitoring — sometimes call for novel approaches.
        </p>
        <p>
          When introducing a new pattern, OUI follows these guidelines:
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            pattern includes documentation explaining why it exists and when
            to use it.
          </li>
          <li>
          ...
          <OuiCallOut
            ...
            <OuiText size="s">
              <p>
                ...
                data-dense interfaces, and updated spacing tokens create
                better visual rhythm across all four focus areas.
              </p>
            </OuiText>
          </OuiCallOut>
        </>
