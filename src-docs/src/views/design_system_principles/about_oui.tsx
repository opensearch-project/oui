      ...
      <OuiText grow={false}>
        ...
        <ul>
          ...
          <li>
            ...
            well-tested, stable component API so that consumers can upgrade
            with confidence.
          </li>
          <li>
          ...
          <li>
            <strong>Comprehensive documentation</strong> &mdash; Every
            component includes usage examples, API documentation, and design
            guidelines to lower the barrier to adoption.
          </li>
        </ul>
      </OuiText>
          ...
          <OuiCallOut
            ...
            <OuiText size="s">
              <p>
                ...
                elevation levels. New projects should adopt v9 as their
                default theme.
              </p>
              <p>
                Explore the <strong>Foundations</strong> section to see the v9
                visual building blocks in detail, including color swatches,
                type scale samples, and elevation examples.
              </p>
            </OuiText>
          </OuiCallOut>
        </>
