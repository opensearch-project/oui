...
const FoundationsTypography: React.FC<ContentPageProps> = ({
  ...
  return (
    <GuidePage title="Typography">
      ...
      <OuiText size="s" color="subdued">
        <p>
          Available font weight tokens. {isV9
      ...
      <OuiText size="s" color="subdued">
        <p>
          Line height tokens control vertical rhythm and readability.
        </p>
      </OuiText>
      <OuiSpacer size="m" />
      ...
      <OuiTable>
        ...
        <OuiTableBody>
          ...
          <OuiTableRow>
            ...
            <OuiTableRowCell>
              Reset value for the body element
            </OuiTableRowCell>
          </OuiTableRow>
        </OuiTableBody>
      </OuiTable>
          ...
          <OuiCallOut
            ...
            <OuiText size="s">
              <p>
                ...
                for log explorers, trace views, and monitoring dashboards.
                Noto Sans provides excellent legibility at small sizes and
                broad Unicode coverage for internationalized content. Heading
                weights shift from Light (300) to Medium/SemiBold (500–600)
                for stronger visual anchoring in complex layouts.
              </p>
            </OuiText>
          </OuiCallOut>
        </>
