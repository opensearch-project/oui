    ...
    <GuidePage title="Spacing & Layout">
      <OuiText grow={false}>
        ...
        <p>
          ...
          from a 16px base unit (
          <OuiCode transparentBackground>$ouiSize</OuiCode>). This creates a
          consistent, predictable rhythm across all components and layouts. The
          scale ranges from 2px (XXS) to 40px (XXL), covering the full range of
          spacing needs from tight icon gaps to generous section padding.
        </p>
      </OuiText>
      ...
      <OuiPanel paddingSize="m">
        ...
        <OuiText size="s" color="subdued">
          <p>
            ...
            <OuiCode transparentBackground>size</OuiCode> prop maps to the same
            spacing tokens:
          </p>
        </OuiText>
        <OuiSpacer size="s" />
      ...
      <OuiText size="s">
        <ul>
          ...
          <li>
            ...
            within a component — icon-to-label gaps, label-to-input spacing, and
            inline badge margins.
          </li>
          <li>
            <strong>Use the base token (M)</strong> as the default gap for flex
            layouts and panel padding. It provides comfortable spacing without
            wasting screen real estate.
          </li>
          <li>
            <strong>Use larger tokens (L, XL, XXL)</strong> to separate distinct
            content sections, page regions, and major layout areas.
          </li>
          <li>
            ...
            <OuiCode transparentBackground>OuiPanel</OuiCode>) over manual CSS
            margins and padding. These components enforce the spacing scale
            automatically.
          </li>
        </ul>
      </OuiText>
