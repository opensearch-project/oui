    ...
    <GuidePage title="Icons">
      ...
      <OuiText size="s">
        <p>
          ...
          <OuiCode transparentBackground>OuiIcon</OuiCode> to control rendering
          size. The default size is <OuiCode transparentBackground>m</OuiCode>{' '}
          (16px), which is appropriate for most inline and button contexts.
        </p>
      </OuiText>
      <OuiSpacer size="m" />
          ...
          {iconSizes.map((entry) => (
            <OuiTableRow key={entry.size}>
              ...
              <OuiTableRowCell>
                ...
                {entry.size === 'm' &&
                  'Default — buttons, form fields, navigation items'}
                {entry.size === 'l' &&
                  'Section headers, empty states, card icons'}
                {entry.size === 'xl' &&
                  'Feature highlights, onboarding illustrations'}
      ...
      <OuiText size="s">
        <p>
          OUI icons are organized into categories based on their purpose. Below
          is a representative sample from each category. For the complete list,
          see the OuiIcon component documentation.
        </p>
      </OuiText>
      ...
      <OuiPanel paddingSize="m">
        ...
        <OuiText size="s">
          <p>
            ...
            <OuiCode transparentBackground>aria-label</OuiCode> prop to describe
            the icon&apos;s purpose:
          </p>
        </OuiText>
        <OuiSpacer size="s" />
      ...
      <OuiPanel paddingSize="m">
        ...
        <OuiText size="s">
          <p>
            ...
            by default when no{' '}
            <OuiCode transparentBackground>aria-label</OuiCode> is provided:
          </p>
        </OuiText>
        <OuiSpacer size="s" />
        <OuiPanel paddingSize="s" color="subdued">
        ...
        <OuiText size="xs">
          <ul style={{ margin: 0 }}>
            ...
            <li>
              ...
              appearance (e.g., &quot;Delete item&quot; not &quot;Trash
              can&quot;).
            </li>
            <li>
