...
const FoundationsColor: React.FC<ContentPageProps> = ({ selectedTheme }) => {
  ...
  return (
    <GuidePage title="Color">
      ...
      <OuiCallOut
        title={
          isDark ? 'Viewing dark mode values' : 'Viewing light mode values'
        }
        iconType="iInCircle"
        color="primary"
        size="s">
        <OuiText size="xs">
          <p>
            The swatches below show {isDark ? 'dark' : 'light'} mode hex values.
          ...
          <OuiCallOut
            ...
            <OuiText size="s">
              <p>
                ...
                Tailwind-inspired color values for core and status tokens. Light
                mode uses warm slate-based neutrals for a softer feel, while
                dark mode uses cool zinc-based neutrals to reduce eye strain.
                Status colors are tuned for higher vibrancy in dark mode to
                maintain visibility against dark backgrounds.
              </p>
            </OuiText>
          </OuiCallOut>
        </>
