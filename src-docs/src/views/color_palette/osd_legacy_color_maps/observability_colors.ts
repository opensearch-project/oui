...
export const COLOR_PALETTES = [
  ...
  },
  {
    ...
    palette: colorPalette(BLUES_PALETTE.colors, 20, false, true),
    type: 'gradient',
  },
  {
    value: REDS_PALETTE.name,
    title: REDS_PALETTE.label,
    palette: colorPalette(REDS_PALETTE.colors, 20, false, true),
    type: 'gradient',
  },
  {
    value: GREENS_PALETTE.name,
    title: GREENS_PALETTE.label,
    palette: colorPalette(GREENS_PALETTE.colors, 20, false, true),
    type: 'gradient',
  },
  {
    value: GREYS_PALETTE.name,
    title: GREYS_PALETTE.label,
    palette: colorPalette(GREYS_PALETTE.colors, 20, false, true),
    type: 'gradient',
  },
  {
    value: BLUE_RED_PALETTE.name,
    title: BLUE_RED_PALETTE.label,
    palette: colorPalette(BLUE_RED_PALETTE.colors, 20, false, true),
    type: 'gradient',
  },
  {
    value: RED_BLUE_PALETTE.name,
    title: RED_BLUE_PALETTE.label,
    palette: colorPalette(RED_BLUE_PALETTE.colors, 20, true, true),
    type: 'gradient',
  },
  {
    value: YELLOW_ORANGE_RED_PALETTE.name,
    title: YELLOW_ORANGE_RED_PALETTE.label,
    palette: colorPalette(YELLOW_ORANGE_RED_PALETTE.colors, 20, false, true),
    type: 'gradient',
  },
  {
    value: YELLOW_GREEN_BLUE_PALETTE.name,
    title: YELLOW_GREEN_BLUE_PALETTE.label,
    palette: colorPalette(YELLOW_GREEN_BLUE_PALETTE.colors, 20, false, true),
    type: 'gradient',
  },
];
...
export const HEATMAP_PALETTE_COLOR = {
