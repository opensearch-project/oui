...
const typeToPathMap = {
  ...
  featureAdministration: 'navigation/featureAdministration',
  featureAiFlow: 'navigation/featureAiFlow',
  featureAlerting: 'navigation/featureAlerting',
  featureAnalyticsWs: 'navigation/featureAnalyticsWs',
  featureAnomalyDetection: 'navigation/featureAnomalyDetection',
  featureDashboards: 'navigation/featureDashboards',
  featureData: 'navigation/featureData',
  featureDetectionRules: 'navigation/featureDetectionRules',
  featureDevtools: 'navigation/featureDevtools',
  featureDiscover: 'navigation/featureDiscover',
  featureEssentialsWs: 'navigation/featureEssentialsWs',
  featureExperiments: 'navigation/featureExperiments',
  featureGetStarted: 'navigation/featureGetStarted',
  featureInfo: 'navigation/featureInfo',
  featureInfra: 'navigation/featureInfra',
  featureIntegrations: 'navigation/featureIntegrations',
  featureJudgements: 'navigation/featureJudgements',
  featureManage: 'navigation/featureManage',
  featureMaps: 'navigation/featureMaps',
  featureModels: 'navigation/featureModels',
  featureNotebooks: 'navigation/featureNotebooks',
  featureNotifications: 'navigation/featureNotifications',
  featureObservabilityWs: 'navigation/featureObservabilityWs',
  featureOverview: 'navigation/featureOverview',
  featureQuerySets: 'navigation/featureQuerySets',
  featureReports: 'navigation/featureReports',
  featureSearchWs: 'navigation/featureSearchWs',
  featureSecurityCases: 'navigation/featureSecurityCases',
  featureSecurityFindings: 'navigation/featureSecurityFindings',
  featureSecurityWs: 'navigation/featureSecurityWs',
  featureServiceMap: 'navigation/featureServiceMap',
  featureServices: 'navigation/featureServices',
  featureSlos: 'navigation/featureSlos',
  featureThreatIntel: 'navigation/featureThreatIntel',
  featureTicketing: 'navigation/featureTicketing',
  featureUi: 'navigation/featureUi',
  searchConfigurationsln: 'navigation/searchConfigurationsln',
};
