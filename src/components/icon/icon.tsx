...
const typeToPathMap = {
  ...
  featureAdministration: 'menus/featureAdministration',
  menusFeatureAiFlow: 'menus/featureAiFlow',
  menusFeatureAlerting: 'menus/featureAlerting',
  menusFeatureAnalyticsWs: 'menus/featureAnalyticsWs',
  menusFeatureAnomalyDetection: 'menus/featureAnomalyDetection',
  menusFeatureDashboards: 'menus/featureDashboards',
  menusFeatureData: 'menus/featureData',
  menusFeatureDetectionRules: 'menus/featureDetectionRules',
  menusFeatureDevtools: 'menus/featureDevtools',
  menusFeatureDiscover: 'menus/featureDiscover',
  menusFeatureEssentialsWs: 'menus/featureEssentialsWs',
  menusFeatureExperiments: 'menus/featureExperiments',
  menusFeatureGetStarted: 'menus/featureGetStarted',
  menusFeatureInfo: 'menus/featureInfo',
  menusFeatureInfra: 'menus/featureInfra',
  menusFeatureIntegrations: 'menus/featureIntegrations',
  menusFeatureJudgements: 'menus/featureJudgements',
  menusFeatureManage: 'menus/featureManage',
  menusFeatureMaps: 'menus/featureMaps',
  menusFeatureModels: 'menus/featureModels',
  menusFeatureNotebooks: 'menus/featureNotebooks',
  menusFeatureNotifications: 'menus/featureNotifications',
  menusFeatureObservabilityWs: 'menus/featureObservabilityWs',
  menusFeatureOverview: 'menus/featureOverview',
  menusFeatureQuerySets: 'menus/featureQuerySets',
  menusFeatureReports: 'menus/featureReports',
  menusFeatureSearchWs: 'menus/featureSearchWs',
  menusFeatureSecurityCases: 'menus/featureSecurityCases',
  menusFeatureSecurityFindings: 'menus/featureSecurityFindings',
  menusFeatureSecurityWs: 'menus/featureSecurityWs',
  menusFeatureServiceMap: 'menus/featureServiceMap',
  menusFeatureServices: 'menus/featureServices',
  menusFeatureSlos: 'menus/featureSlos',
  menusFeatureThreatIntel: 'menus/featureThreatIntel',
  menusFeatureTicketing: 'menus/featureTicketing',
  menusFeatureUi: 'menus/featureUi',
  menusSearchConfigurationsln: 'menus/searchConfigurationsln',
};
