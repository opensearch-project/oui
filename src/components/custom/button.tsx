  ...
  "oui:inline-flex oui:items-center oui:justify-center oui:gap-2 oui:whitespace-nowrap oui:text-sm oui:font-medium oui:transition-all oui:disabled:pointer-events-none oui:disabled:opacity-50 oui:[&_svg]:pointer-events-none oui:[&_svg:not([class*='size-'])]:size-4 oui:shrink-0 oui:[&_svg]:shrink-0 oui:outline-none oui:focus-visible:border-ring oui:focus-visible:ring-ring/50 oui:focus-visible:ring-[3px] oui:aria-invalid:ring-destructive/20 oui:dark:aria-invalid:ring-destructive/40 oui:aria-invalid:border-destructive oui:rounded-full oui:active:opacity-60 oui:active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        outline:
          'oui:border oui:bg-background oui:shadow-xs oui:hover:bg-accent oui:hover:text-accent-foreground oui:dark:bg-input/30 oui:dark:border-input oui:dark:hover:bg-input/50 oui:text-primary oui:active:bg-accent oui:dark:active:bg-input/50',
        secondary:
          'oui:bg-secondary oui:text-secondary-foreground oui:hover:bg-secondary/80 oui:text-primary oui:border oui:border-primary oui:active:bg-secondary/70',
        ghost:
          'oui:hover:bg-accent oui:hover:text-accent-foreground oui:dark:hover:bg-accent/50 oui:text-primary oui:active:bg-accent oui:dark:active:bg-accent/50',
